...
// ================= FULL CBE CURRICULUM =================
const subjects = {
  /* Use the full structured subjects object from previous message, all senior school subjects filled */
};
...
function enterTeacher(){
  ...
  if(pass==="admin123"){
    document.getElementById("panel").innerHTML=`<div class='section'>
      ...
      <button onclick='viewStudents()'>View Student Reports</button>
    </div>`;
